...
export const EXCEL_FILE_PATH = '/public/Firewall Sparks Leaderboard.xlsx';
...
export function getExcelFilePath(): string {
  ...
  if (currentPath.includes('/Firewall_Sparks_Leaderboard/')) {
    return '/Firewall_Sparks_Leaderboard/public/Firewall Sparks Leaderboard.xlsx';
  }
  ...
  const possiblePaths = [
    ...
    './public/Firewall Sparks Leaderboard.xlsx',
    'public/Firewall Sparks Leaderboard.xlsx',
    '/assets/public/Firewall Sparks Leaderboard.xlsx'
  ];
